  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute bg-base-100 inset-0 opacity-0",
        ...
        week_number: cn(
          "text-[0.8rem] select-none text-base-content/70",
        ...
        range_start: cn(
          "rounded-l-md bg-primary text-primary-content",
        ...
        outside: cn(
          "text-base-content/50 aria-selected:text-base-content/50",
...
function DaisyCalendarDayButton({
  className,
  day,
  modifiers,
  ...props
